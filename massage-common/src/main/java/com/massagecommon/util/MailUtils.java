...
public class MailUtils {
     ...
     */
    public  void sendMultipleEmail(String emails, String code) throws Exception {
        ...
        message.setRecipients(RecipientType.TO,
                new Address[] {
                        ...
                        new InternetAddress(emails, "审查员",charset)
                }
        );
     /*   if(emails.size()-1>0){
            emails.forEach(n -> {
        ...
        message.setReplyTo(InternetAddress.parse("\"" + MimeUtility.encodeText("按摩小程序公众号") + "\" <"+from+">"));
        // 设置优先级(1:紧急   3:普通    5:低)
...
//        imgPart.setContentID("psb.jpg");
        ...
        htmlContent.setContent(
                "<span style='color:red'>验证码："+code+"</br>"
