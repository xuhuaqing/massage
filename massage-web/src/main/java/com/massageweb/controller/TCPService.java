...
import static com.massageweb.controller.Server1.END_CHAR;

/**
 * Created by WuShuang on 2020/5/13.
 */
public class TCPService{
    // public static final String SERVICE_IP = "172.31.116.219";
...
//                        connect.close();
    ...
    private String facStatus(String msg){
        String[] split = msg.split("=");
        String key = split[0].substring(1);
        String value = split[1];
        try {
            //获得解密的密码
            String decrypt = show1("", key.substring(4));
